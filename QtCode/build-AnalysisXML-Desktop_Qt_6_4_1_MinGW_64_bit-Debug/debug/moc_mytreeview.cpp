...
#include <memory>
#include "../../AnalysisXML/mytreeview.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MyTreeView_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MyTreeView_t qt_meta_stringdata_MyTreeView = {
    {
        QT_MOC_LITERAL(0, 10)   // "MyTreeView"
    },
    "MyTreeView"
};
...
Q_CONSTINIT static const uint qt_meta_data_MyTreeView[] = {
...
Q_CONSTINIT const QMetaObject MyTreeView::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyTreeView.offsetsAndSizes,
    qt_meta_data_MyTreeView,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MyTreeView_t,
        // Q_OBJECT / Q_GADGET
